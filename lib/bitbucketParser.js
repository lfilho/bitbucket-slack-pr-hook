...
module.exports = (function () {
    ...
    var messageHandlers = {
        ...
        updated: function (pr) {
            ...
            result.fallback =  '<' + data.prUrl + '|Pool request> by ' + data.prAuthor + ' for ' + data.repoName + ' *updated* for ' + data.repoName + ':';
        ...
        approved: function (pr) {
            ...
            var result = {
                fallback: data.user + ' *approved* a ' + '<' + data.prUrl + '|PR by ' + data.prAuthor + '> for ' + data.repoName + ':',
        ...
        unapproved: function (pr) {
            ...
            var result = {
                fallback: data.user + ' *UNapproved* a ' + '<' + data.prUrl + '|PR by ' + data.prAuthor + '> for ' + data.repoName + ':',
        ...
        rejected: function (pr) {
            ...
            result.fallback = 'PR *rejected*:' + '<' + data.prUrl + '|PR by ' + data.prAuthor + '> for ' + data.repoName + ':';
        ...
        fulfilled: function (pr) {
            ...
            result.fallback = 'PR *merged*:' + '<' + data.prUrl + '|PR by ' + data.prAuthor + '> for ' + data.repoName + ':';
        ...
        comment_created: function (pr) {
            ...
            var result = {
                fallback: data.user + ' *posted* <' + data.commentUrl + '|a comment> on a PR by ' + data.prAuthor + ":",
                color: util.COLORS.yellow,
                fields: [{
        ...
        comment_deleted: function (pr) {
            ...
            var result = {
                fallback: data.user + ' *deleted* <' + data.commentUrl + '|a comment> on a PR by ' + data.prAuthor + ":",
                color: util.COLORS.yellow,
                fields: [{
                    value: util.truncate(data.commentContentRaw)
                }]
        ...
        comment_updated: function (pr) {
            ...
            var result = {
                fallback: data.user + ' *updated* <' + data.commentUrl + '|a comment> on a PR by ' + data.prAuthor + ":",
                color: util.COLORS.yellow,
                fields: [{
                    value: util.truncate(data.commentContentRaw)
                }]
