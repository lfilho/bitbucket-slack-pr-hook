...
var extractPrData = function (pr) {
    ...
    return {
        ...
        prAuthorId: getKey('pullRequest.author.user.name'),
...
module.exports = (function () {
    ...
    var messageHandlers = {
        opened: function (pr) {
            ...
            result = util.addReviewers(data, result);
        ...
        approved: function (pr) {
            ...
            result = util.addPROwner(data, result);
            return util.FEATURE_USE_EMOJI.useEmojis ? util.addEmoji(result) : result;
        },
        ...
        cadded: function (pr) {
            ...
            result.fields.push({
                title: 'Added Comment:',
                value: util.convertToUserMentions(util.truncate(data.commentText)),
                short: true
            });
