...
var extractPrData = function (pr) {
    ...
    var data = {
        ...
        reason              : getKey('pullrequest.reason'),
...
module.exports = (function () {
    ...
    var messageHandlers = {
        created: function (pr) {
            ...
            var result = {
                fallback: 'Pull Request ' + data.repoName + ' → <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '> opened by ' + data.prAuthor,
        ...
        updated: function (pr) {
            ...
            result.fallback = data.repoName + ' → <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '> updated by ' + data.prAuthor;
        ...
        approved: function (pr) {
            ...
            var result = {
                fallback: data.user + ' approved ' + data.repoName + ' → <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '>',
        ...
        unapproved: function (pr) {
            ...
            var result = {
                fallback: data.user + ' unapproved ' + data.repoName + ' → <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '>',
