...
module.exports = (function () {
    ...
    var messageHandlers = {
        created: function (pr) {
            ...
            var result = {
                fallback: 'Pull Request <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '> opened by ' + data.prAuthor + ' for ' + data.repoName + ':',
        ...
        updated: function (pr) {
            ...
            result.fallback = '<' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '> updated by ' + data.prAuthor + ' for ' + data.repoName + ':';
        ...
        approved: function (pr) {
            ...
            var result = {
                fallback: data.user + ' approved <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '> for ' + data.repoName,
        ...
        unapproved: function (pr) {
            ...
            var result = {
                fallback: data.user + ' unapproved <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '> for ' + data.repoName,
        ...
        rejected: function (pr) {
            ...
            result.fallback = '<' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '> was rejected';
        ...
        fulfilled: function (pr) {
            ...
            result.fallback = '<' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '> was merged';
        ...
        comment_created: function (pr) {
            ...
            var result = {
                fallback: data.user + ' commented on <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '>',
                color: util.COLORS.yellow,
                fields: [{
        ...
        comment_deleted: function (pr) {
            ...
            var result = {
                fallback: data.user + ' deleted a comment on <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '>',
                color: util.COLORS.yellow,
                fields: [{
                    value: util.truncate(data.commentContentRaw)
                }]
        ...
        comment_updated: function (pr) {
            ...
            var result = {
                fallback: data.user + ' updated a comment on <' + data.prUrl + '|#' + data.prNumber + ' ' + data.prTitle + '>',
                color: util.COLORS.yellow,
                fields: [{
                    value: util.truncate(data.commentContentRaw)
                }]
