...
module.exports = (function () {
    var baseHandler = function (pr) {
        ...
        var result = {
            fields: [{
                title: data.prNumber + ' - ' + data.prTitle,
    ...
    var messageHandlers = {
        created: function (pr) {
            ...
            var result = {
                fallback: '<' + data.prUrl + '|' + data.prTitle + ' *created* by ' + data.prAuthor + '> for ' + data.repoName + ':',
        ...
        updated: function (pr) {
            ...
            result.fallback = '<' + data.prUrl + '|' + data.prTitle + ' *updated* by ' + data.prAuthor + '> for ' + data.repoName + ':';
        ...
        approved: function (pr) {
            ...
            var result = {
                fallback: data.user + ' *approved* <' + data.prUrl + '|' + data.prTitle + '> for ' + data.repoName,
        ...
        unapproved: function (pr) {
            ...
            var result = {
                fallback: data.user + ' *unapproved* <' + data.prUrl + '|' + data.prTitle + '> for ' + data.repoName,
